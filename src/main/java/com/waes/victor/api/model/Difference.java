...
public class Difference implements Serializable {
     ...
     * @throws WaesApiRuntimeException the waes api runtime exception
     */
    public Difference compareSides() throws  WaesApiRuntimeException{
     ...
     * Check if both sides are available
     */
    private void checkBothSidesAvailability() throws WaesApiRuntimeException{
    ...
    private List<DifferenceDetail> getDifferencesDetails() throws WaesApiRuntimeException{
        ...
        try {
            ...
            throw new WaesApiRuntimeException(WaesApiMessage.ERROR_COMPARING_SIDES);
        }
